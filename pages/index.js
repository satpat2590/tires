...
import Alternating from '../src/app/Alternating'
      ...
      <section className="relative bg-cover bg-center h-[300px] md:h-[400px] lg:h-[500px] w-screen" style={{ backgroundImage: `url('dalletruck.png')` }}>
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center">
          <div className="text-center p-4 mx-4 md:mx-auto max-w-xs md:max-w-sm lg:max-w-xl"> {/* Responsive max-width */}
            ...
            {/* Browse Tires Button */}
            <a className="inline-flex" href="/products">
              <span className="h-12 flex items-center justify-center uppercase font-semibold px-8 border border-black hover:bg-black hover:text-white transition duration-500 ease-in-out">shop now</span>
              ...
              <svg className="h-3 w-3 scale-150" aria-hidden="true" focusable="false" data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
